namespace Курсова_
{
	partial class Form3_Pracivnuki
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.pracivnukiBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.dataBaseDataSet = new Курсова_.DataBaseDataSet();
			this.pracivnukiTableAdapter = new Курсова_.DataBaseDataSetTableAdapters.PracivnukiTableAdapter();
			this.guna2Button5 = new Guna.UI2.WinForms.Guna2Button();
			this.працівникіToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.menuStrip1.SuspendLayout();
			this.guna2GroupBox1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.pracivnukiBindingSource)).BeginInit();
            ...
            this.працівникіToolStripMenuItem});
			...
			this.guna2Button7.Location = new System.Drawing.Point(12, 388);
			this.guna2Button7.Name = "guna2Button7";
			this.guna2Button7.Size = new System.Drawing.Size(209, 100);
			this.guna2Button7.TabIndex = 18;
			this.guna2Button7.Text = "Обновити базу данних";
			...
			this.guna2Button4.Text = "Управління асортиментом";
			...
			this.dataGridView1.DataSource = this.pracivnukiBindingSource;
			...
			// 
			// pracivnukiBindingSource
			// 
			this.pracivnukiBindingSource.DataMember = "Pracivnuki";
			this.pracivnukiBindingSource.DataSource = this.dataBaseDataSet;
			// 
			// dataBaseDataSet
			// 
			...
			// 
			// pracivnukiTableAdapter
			// 
			this.pracivnukiTableAdapter.ClearBeforeFill = true;
			// 
			// guna2Button5
			// 
			...
			// 
			// працівникіToolStripMenuItem
			// 
			this.працівникіToolStripMenuItem.Name = "працівникіToolStripMenuItem";
			this.працівникіToolStripMenuItem.Size = new System.Drawing.Size(80, 20);
			this.працівникіToolStripMenuItem.Text = "Працівникі";
			// 
			// Form3_Pracivnuki
			// 
			...
			this.Name = "Form3_Pracivnuki";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Form3_Pracivnuki";
			this.Load += new System.EventHandler(this.Form3_Pracivnuki_Load);
			this.menuStrip1.ResumeLayout(false);
			this.menuStrip1.PerformLayout();
			this.guna2GroupBox1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.pracivnukiBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource pracivnukiBindingSource;
		private DataBaseDataSetTableAdapters.PracivnukiTableAdapter pracivnukiTableAdapter;
		...
		private System.Windows.Forms.ToolStripMenuItem працівникіToolStripMenuItem;
	}
}